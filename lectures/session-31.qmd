...
| **Slides needed** | T1: ~5 new + ~9 from Class 26; T2: ~5 new + ~14 from Classes 26, 28, 29 |
...
- **Speaker notes:** Final substantive session. Help students see the arc.
...
- **Speaker notes:** Show progression. Students should feel pride.
...
- **Speaker notes:** Concrete numbers. Students should know these on exit.
...
- **Speaker notes:** Realistic timeline. Not overnight; not never.
...
- **Speaker notes:** These are research projects students can do post-course.
...
- **Speaker notes:** Direct career relevance. Students from each path should see themselves.

### Track 1 Existing Slides to Reuse

From Class 26 (Research Frontiers & Course Synthesis) — 9 slides
- Adoption pathway
- Open practitioner questions
...
- **Speaker notes:** Each of these is a thesis chapter or research paper opportunity.
...
- **Speaker notes:** Place GE-LAV in the research ecosystem. Students should see it as one node in a broader network.
...
- **Speaker notes:** Connect to active research conversations.

### Track 2 Existing Slides to Reuse

From Class 26 + Classes 28-29 (Neural SDE + Network):
- 14 slides on theoretical frontiers
- Advanced empirical/numerical techniques
