...
This document organizes the course readings by unit and session, with brief annotations indicating relevance. Full BibTeX citations are in [references.bib](../references.qmd).
...
[← Syllabus](../syllabus.qmd) | [References.bib →](../references.qmd)
